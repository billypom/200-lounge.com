      ...
      <main className={styles.main}>
        ...
        <div className="flex flex-col text-center z-10 items-center">
          ...
          <div className="flex flex-row flex-wrap">
            ...
            <RecordsTable data={all6} title='6v6'></RecordsTable>
          </div>
          ...
          <div className="flex flex-row flex-wrap">
            ...
            <RecordsTable data={a6} title='6v6'></RecordsTable>
          </div>
          ...
          <div className="flex flex-row flex-wrap">
            ...
            <RecordsTable data={b6} title='6v6'></RecordsTable>
          </div>
          ...
          <div className="flex flex-row flex-wrap">
            ...
            <RecordsTable data={c6} title='6v6'></RecordsTable>
          </div>
