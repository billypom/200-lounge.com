      ...
      <main className={styles.main}>
        ...
        <div className='flex flex-row flex-wrap max-w-4xl m-auto justify-center z-10'>
          ...
          <div className={styles.player_page_stats}>
            ...
            <div className='cursor-pointer hover:underline dark:text-cyan-300 text-blue-500'><Link href={"/s5/mogi/" + lg[0].mogi_id}>{results[0]["largest gain"]}</Link></div>
          </div>

          <div className={styles.player_page_stats}>
            <h2 className='text-xl font-bold'>largest loss</h2>
            <div className='cursor-pointer hover:underline dark:text-cyan-300 text-blue-500'><Link href={"/s5/mogi/" + ll[0].mogi_id}>{results[0]["largest loss"]}</Link></div>
          </div>
