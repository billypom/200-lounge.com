    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className="flex flex-col text-center z-10 items-center">
            <h2 className={`${styles.tier_title} dark:bg-zinc-800/75 bg-neutral-200/75`}>
                  ...
                  <TableBody>
                    {all2.map((row, idx) => (
                      <StyledTableRow key={row.mogi_id}>
                        ...
                        <StyledTableCell align="center">
                          <div className="dark:text-cyan-300 text-blue-500 cursor-pointer hover:underline"><Link href={"/mogi/" + row.mogi_id }>{row.score}</Link></div>
                        </StyledTableCell>
                      </StyledTableRow>
